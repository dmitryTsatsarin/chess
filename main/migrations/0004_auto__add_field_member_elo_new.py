...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.elo_new'
        db.add_column('main_member', 'elo_new',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.elo_new'
        db.delete_column('main_member', 'elo_new')
    ...
    models = {
        'main.member': {
            ...
            'elo_new': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
